...
async function makeTestEpub(): Promise<Buffer> {
  const zip = new JSZip();
  ...
  zip.file("OEBPS/chapter.xhtml", `<html xmlns="http://www.w3.org/1999/xhtml"><body><h1>Chapitre de test</h1><p>Ce texte confirme que le fichier EPUB est lu.</p></body></html>`);
